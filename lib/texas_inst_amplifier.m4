...
# 
#   RCS: $Id: texas_inst_amplifier.m4,v 1.1 2003-02-20 00:23:34 danmc Exp $
#
...
define(`PinList_TL074_dil',  ``Out1',`In1-',`In1+',`Vcc+',`In2+',`In2-',`Out2',`Out3',`In3-',`In3+',`Vcc-',`In4+',`In4-',`Out4'')

define(`Description_TL075_dil', `Quad JFET input operational amplifiers')
define(`Param1_TL075_dil', 14)
define(`Param2_TL075_dil', 300)
define(`PinList_TL075_dil',  ``In1-',`In1+',`Out1',`Out2',`In2+',`In2-',`Vcc-',`In3-',`In3+',`Out3',`Vcc+',`Out4',`In4+',`In4-'')
...
define(`Description_uA709C_dil', `Single general purpose operational amplifier')
define(`Param1_uA709C_dil', 8)
define(`Param2_uA709C_dil', 300)
define(`PinList_uA709C_dil',  ``FreqCompB',`In-',`In+',`Vcc-',`OutFreqComp',`Out',`Vcc+',`FreqCompA'')

define(`Description_uA741C_dil', `Single general purpose operational amplifier')
define(`Param1_uA741C_dil', 8)
define(`Param2_uA741C_dil', 300)
define(`PinList_uA741C_dil',  ``OfsN1',`In-',`In+',`Vcc-',`OfsN2',`Out',`Vcc+',`NC'')
...
define(`Param2_uA748C_dil', 300)
define(`PinList_uA748C_dil',  ``N1Comp',`In-',`In+',`Vcc-',`OfsN2',`Out',`Vcc+',`Comp'')
