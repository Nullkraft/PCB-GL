/* $Id: gui-config.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $ */
...
RCSID ("$Id: gui-config.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $");
...
static gchar	*lib_newlib_config,
				*groups_config,		/* Saved in the config	*/
				*routes_config,
				*groups_override,	/* Overrides from command line	*/
				*routes_override,
				*board_size_override;
...
static void
config_auto_pan_speed_spin_button_cb(GtkSpinButton *spin_button, gpointer data)
	{
...
config_general_tab_create(GtkWidget *tab_vbox)
	...
	vbox = ghid_category_vbox(tab_vbox, _("Enables"),
				4, 2, TRUE, TRUE);
	...
	vbox = ghid_category_vbox(tab_vbox, _("Backups"),
				4, 2, TRUE, TRUE);
	...
	ghid_spin_button(vbox, NULL, Settings.BackupInterval,
	...
	vbox = ghid_category_vbox(tab_vbox, _("Misc"),
				4, 2, TRUE, TRUE);
	...
	*/
	...
	ghid_table_spin_button(table, 3, 0, NULL,
 	...
 	ghid_table_spin_button(table, 4, 0, NULL,
 			...
 			STEP0_SMALL_SIZE, STEP1_SMALL_SIZE,
 			SPIN_DIGITS, 0, size_spin_button_cb,
 			&PCB->minDrill, FALSE, _("Minimum drill diameter"));
 	...
 	ghid_table_spin_button(table, 5, 0, NULL,
 			...
 			STEP0_SMALL_SIZE, STEP1_SMALL_SIZE,
 			SPIN_DIGITS, 0, size_spin_button_cb,
 			&PCB->minRing, FALSE, _("Minimum annular ring"));
