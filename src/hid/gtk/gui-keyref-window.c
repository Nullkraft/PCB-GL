/* $Id: gui-keyref-window.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $ */
...
RCSID("$Id: gui-keyref-window.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $");
...
ghid_keyref_window_show(void)
	...
	gtk_window_set_title(GTK_WINDOW(keyref_window),
				_("PCB Key Reference"));
	gtk_window_set_wmclass(GTK_WINDOW(keyref_window),
				"PCB_Keyref", "PCB");
	gtk_window_set_default_size(GTK_WINDOW(keyref_window),
				ghidgui->keyref_window_width, ghidgui->keyref_window_height);
