/* $Id: gui-utils.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $ */
...
RCSID("$Id: gui-utils.c,v 1.1 2006-03-21 17:35:00 djdelorie Exp $");
...
ghid_draw_area_update(GHidPort *port, GdkRectangle *rect)
{
  ...
  gdk_window_invalidate_rect(port->drawing_area->window, &update_rect, FALSE);
}
...
ghid_button_connected(GtkWidget *box, GtkWidget **button,
		     gboolean pack_start, gboolean expand, gboolean fill, gint pad,
...
void
ghid_range_control(GtkWidget *box, GtkWidget **scale_res, gboolean horizontal,
		  GtkPositionType pos, gboolean set_draw_value, gint digits,
		  gboolean pack_start, gboolean expand, gboolean fill, guint pad,
		  gfloat value, gfloat low, gfloat high, gfloat step0, gfloat step1,
