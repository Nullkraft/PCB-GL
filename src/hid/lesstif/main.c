...
ghid_draw_line (hidGC gc, Coord x1, Coord y1, Coord x2, Coord y2)
{
  ...
  hidgl_draw_line (lesstif_gc->cap, lesstif_gc->width, x1, y1, x2, y2, view_zoom);
}
                         ...
                         Angle start_angle, Angle delta_angle)
{
  ...
  hidgl_draw_arc (lesstif_gc->width, cx, cy, xradius, yradius,
...
hid_lesstif_init ()
{
  ...
  lesstif_hid.set_layer               = ghid_set_layer;
  lesstif_hid.end_layer               = ghid_end_layer;
  ...
  lesstif_graphics.use_mask            = ghid_use_mask;
  lesstif_graphics.set_color           = ghid_set_color;
  lesstif_graphics.set_line_cap        = ghid_set_line_cap;
  lesstif_graphics.set_line_width      = ghid_set_line_width;
  lesstif_graphics.set_draw_xor        = ghid_set_draw_xor;
  lesstif_graphics.draw_line           = ghid_draw_line;
  lesstif_graphics.draw_arc            = ghid_draw_arc;
  lesstif_graphics.draw_rect           = ghid_draw_rect;
  lesstif_graphics.fill_circle         = ghid_fill_circle;
  lesstif_graphics.fill_polygon        = ghid_fill_polygon;
  lesstif_graphics.fill_pcb_polygon    = ghid_fill_pcb_polygon;
  lesstif_graphics.thindraw_pcb_polygon = ghid_thindraw_pcb_polygon;
  lesstif_graphics.fill_rect           = ghid_fill_rect;
