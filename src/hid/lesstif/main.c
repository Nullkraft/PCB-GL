...
hid_lesstif_init ()
{
  ...
  lesstif_hid.use_mask                = ghid_use_mask;
  lesstif_hid.set_color               = ghid_set_color;
  lesstif_hid.set_line_cap            = ghid_set_line_cap;
  lesstif_hid.set_line_width          = ghid_set_line_width;
  lesstif_hid.set_draw_xor            = ghid_set_draw_xor;
  lesstif_hid.draw_line               = ghid_draw_line;
  lesstif_hid.draw_arc                = ghid_draw_arc;
  lesstif_hid.draw_rect               = ghid_draw_rect;
  lesstif_hid.fill_circle             = ghid_fill_circle;
  lesstif_hid.fill_polygon            = ghid_fill_polygon;
  lesstif_hid.fill_pcb_polygon        = ghid_fill_pcb_polygon;
  lesstif_hid.thindraw_pcb_polygon    = ghid_thindraw_pcb_polygon;
  lesstif_hid.fill_rect               = ghid_fill_rect;
