/* $Id: netlist.c,v 1.3 2006-03-22 22:49:30 danmc Exp $ */
...
RCSID("$Id: netlist.c,v 1.3 2006-03-22 22:49:30 danmc Exp $");
...
NetlistChanged (int argc, char **argv, int x, int y)
{
  ...
  netlist_strings = (XmString *)malloc(PCB->NetlistLib.MenuN * sizeof(XmString));
  for (i=0; i<PCB->NetlistLib.MenuN; i++)
    netlist_strings[i] = XmStringCreateLocalized(PCB->NetlistLib.Menu[i].Name);
  n = 0;
