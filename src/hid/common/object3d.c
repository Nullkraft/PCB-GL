...
object3d_from_contours (const POLYAREA *contours,
                        ...
                        const appearance *master_topbot_appearance)
{
  GList *objects = NULL;
  object3d *object;
  appearance *object_appearance;
  appearance *topbot_appearance;
  const POLYAREA *pa;
  PLINE *contour;
  PLINE *ct;
  int ncontours;
  ...
  do {
    ...
    topbot_appearance = make_appearance ();
    appearance_set_appearance (object_appearance, master_object_appearance);
    appearance_set_appearance (topbot_appearance, master_topbot_appearance);
    ...
    face3d_set_appearance (faces[npoints], topbot_appearance);
    object3d_add_face (object, faces[npoints]);

    faces[npoints + 1] = make_face3d (); /* top_face */
    face3d_set_normal (faces[npoints + 1], 0., 0., -1.);
    face3d_set_appearance (faces[npoints + 1], topbot_appearance);
    ...
    if (0) {
      ...
      face3d_set_appearance (cylinder_faces[1], topbot_appearance);
...
object3d_from_board_outline (void)
{
  ...
  appearance_set_color (topbot_appearance, 0.2, 0.8, 0.2);
  ...
  destroy_appearance (topbot_appearance);
