/* $Id: output.c,v 1.21 2006-08-02 15:55:18 djdelorie Exp $ */
...
RCSID ("$Id: output.c,v 1.21 2006-08-02 15:55:18 djdelorie Exp $");
...
Pan (LocationType X, LocationType Y, Boolean Scroll, Boolean Update)
{
  ...
  theScreen.Y2 = vyh =
    MIN (PCB->MaxHeight, MAX (TO_PCB_Y (0), TO_PCB_Y (Output.Height)));
